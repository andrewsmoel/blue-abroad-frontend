...
class Auth {
  ...
  async signUp(userData) {
    ...
    if (!response.ok) {
      ...
      // show error      
      _Toast.default.show("Problem getting user: ".concat(response.status), 'error');
  ...
  async signIn(userData) {
    ...
    if (!response.ok) {
      ...
      if (data.redirect) {
        ...
        (0, _Router.gotoRoute)(data.redirect);
      } else {
        this.currentUser.newUser ? (0, _Router.gotoRoute)('/welcome') : (0, _Router.gotoRoute)('/');
      }
    }
  }
  async check(success) {
...
class HomeView {
  init() {
    ...
    console.log('Auth.currentUser in HomeView.init:', _Auth.default.currentUser);
    document.title = 'Home';
    this.render();
  ...
  postGetHandler() {
    fetch('http://localhost:3000/post').then(response => response.json()).then(posts => {
      console.log('posts:', posts); // Log the posts
      console.log('Auth.currentUser._id:', _Auth.default.currentUser._id); // Log the current user's ID
      ...
      if (forumsContainer) {
        ...
        const userPosts = posts.filter(post => {
          ...
          return post.author === _Auth.default.currentUser._id;
        });
        ...
        userPosts.forEach((post, index) => {
          ...
          if (post.author) {
            ...
            fetch("".concat(_App.default.apiBase, "/user/").concat(post.author), {
              headers: {
                'Authorization': "Bearer " + localStorage.getItem('accessToken')
              }
            }).then(response => response.json()).then(author => {
              if (author && author.avatar) {
                const avatarUrl = "".concat(_App.default.apiBase, "/images/").concat(author.avatar);
...
class SignInView {
  ...
  signInSubmitHandler(e) {
    ...
    // sign in using Auth    
    _Auth.default.signIn(userData).then(response => {
      submitBtn.removeAttribute('loading');
      if (response && response.redirect) {
        // If the server responded with a redirect, navigate to that page
        (0, _Router.gotoRoute)(response.redirect);
      }
    }).catch(error => {
...
class SignUpView {
  ...
  renderWelcomeScreen() {
    ...
    const template = (0, _litHtml.html)(_templateObject(), () => (0, _Router.gotoRoute)('/explore'));
    const container = document.querySelector('.page-content');
    (0, _litHtml.render)(template, container);
  }
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject2(), this.signUpSubmitHandler, _Router.anchorRoute);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["\n                    <sl-avatar style=\"--size: 80px;\" image=\"", "/images/", "\"></sl-avatar>\n                    <input class=\"upload\" type=\"file\" name=\"avatar\" />\n                  "]);
...
function _templateObject3() {
  const data = _taggedTemplateLiteral(["\n          <h1>EDIT PROFILE</h1>\n          <div class=\"user-container\">\n            <div class=\"user-info\">\n              <sl-form class=\"page-form\" @sl-submit=", ">\n                <div class=\"input-group\">\n                  <sl-input type=\"text\" class=\"label-on-left\" label=\"First Name\" name=\"firstName\" value=\"", "\" placeholder=\"First Name\"></sl-input>\n                </div>\n                <div class=\"input-group\">\n                  <sl-input type=\"text\" class=\"label-on-left\" label=\"Last Name\" name=\"lastName\" value=\"", "\" placeholder=\"Last Name\"></sl-input>\n                </div>\n                <div class=\"input-group\">\n                  <sl-input type=\"text\" class=\"label-on-left\" label=\"Email\" name=\"email\" value=\"", "\" placeholder=\"Email Address\"></sl-input>\n                </div>\n                <div class=\"input-bio\">\n                  <sl-textarea resize=\"auto\" type=\"text\" class=\"label-on-left\" label=\"Bio\" name=\"bio\" value=\"", "\" placeholder=\"Tell us about yourself!\"></sl-textarea>\n                </div>                   \n                <div class=\"input-avatar\">    \n                  ", "\n                </div>\n                <sl-button type=\"primary\" class=\"submit-btn\" submit >Update Profile</sl-button>\n              </sl-form>\n            </div>  \n            <p>Last Updated: ", "</p>\n          </div>\n        "]);
  _templateObject3 = function _templateObject3() {
    return data;
  };
  return data;
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.updateProfileSubmitHandler.bind(this), this.user.firstName, this.user.lastName, this.user.email, this.user.bio ? this.user.bio : '', this.user.avatar ? (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject5()), (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM Do YYYY, @ h:mm a')));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new EditProfileView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"views/pages/forums.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n            \n\n        <style>\n            \n        h1 {\n            margin-left: 20%;\n        }\n\n        h2 {\n            color: #222633;\n            margin-top: 1em;\n            margin-left: 20px;\n        }\n\n        .forums-container {\n            background-color: #EDEBEB;\n            margin-left: 20%;\n            margin-right: 20%;\n            border-radius: 15px;\n            display: flex;\n            flex-direction: column;\n            min-height: 80vh;\n        }\n            \n        .new-post {\n            margin-top: .5em;\n            margin-left: auto;\n            margin-right: 20px;\n        }\n\n        .inner-cont {\n            background-color: #222633;\n            margin-top: 1em;\n            display: flex;\n            flex-direction: column;\n            gap: 30px;\n            height: 90%;\n            border-radius: 15px;\n            margin-left: 20px;\n            margin-right: 20px;\n            margin-bottom: 20px;\n            flex-grow: 1;\n        }\n\n        .inner-cont div {\n            color: #F0F0F0;\n            padding-left: 20px;\n        }\n\n        .inner-cont div:first-child {\n            margin-top: 25px;\n        }\n\n        .header-cont {\n            display: flex;\n            flex-direction: row;\n            justify-content: space-between;\n        }\n            \n        @media screen and (max-width: 390px) {\n            body {\n                overflow-x: hidden;\n              } \n\n              h1 {\n                margin-left: 2%;\n              }\n            \n              .page-content {\n                justify-content: center;\n                align-items: center;\n                width: 100%;\n                overflow-x: hidden;\n              }\n\n              .forums-container {\n                margin-left: 2%;\n                margin-right: 2%;\n                width: 350px;\n              }\n        }\n\n\n        \n        </style>\n\n        <va-app-header user=\"", "\"></va-app-header>\n        <div class=\"page-content\">        \n            <h1>DISCUSSIONS</h1>\n            <div class=\"forums-container\">\n                <div class=\"header-cont\">\n                    <h2>JOIN IN ON THE CONVERSATION</h2>\n                    <sl-tooltip content=\"New Post\">\n                        <sl-icon-button class=\"new-post\" name=\"plus-circle\" label=\"New Post\" style=\"font-size: 1.8rem;\" @click=", "></sl-icon-button>\n                    </sl-tooltip>\n                </div>\n                <div class=\"inner-cont\">\n                    \n                </div>\n            </div>\n            \n        </div>      \n        "]);
  _templateObject = function _templateObject() {
    return data;
  };
  return data;
...
class ForumView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), () => (0, _Router.gotoRoute)('/newPost'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new ForumView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js"}],"views/pages/newPost.js":[function(require,module,exports) {
"use strict";
...
class newPostView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.postSubmitHandler, () => (0, _Router.gotoRoute)('/forums'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new newPostView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","../../Toast":"Toast.js"}],"views/pages/forumPost.js":[function(require,module,exports) {
"use strict";
...
class forumPostView {
  ...
  async getPostData(postId) {
    // Fetch the post data from the server
    const response = await fetch("http://localhost:3000/post/".concat(postId), {
      headers: {
        "Authorization": "Bearer " + localStorage.getItem('accessToken')
      }
    });
    ...
    const authorResponse = await fetch("http://localhost:3000/user/".concat(postData.author), {
      headers: {
        "Authorization": "Bearer " + localStorage.getItem('accessToken')
      }
    });
    ...
    postData.authorName = "".concat(authorData.firstName, " ").concat(authorData.lastName);

    // Add the author's avatar to the post data
    postData.authorAvatar = "".concat(_App.default.apiBase, "/images/").concat(authorData.avatar);
    return postData;
  }
  renderPosts(posts) {
    const innerContainer = document.querySelector('.inner-cont');
        ...
        if (post.author) {
          ...
          fetch("".concat(_App.default.apiBase, "/user/").concat(post.author), {
            ...
            if (author && author.firstName && author.lastName) {
              authorDiv.textContent = "".concat(author.firstName, " ").concat(author.lastName);
            }
          }).catch(err => console.error(err)); // Handle any errors
        }
          ...
          if (!postDiv.querySelector('sl-dialog')) {
            ...
            commentButton.addEventListener('click', async () => {
              ...
              const commentData = {
                ...
                // Replace with the actual method to get the author ID
                comment: slInput.value,
                // Get the comment from the sl-input element
                postId: postId
              };
              try {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.postData.title);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new forumPostView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js"}],"../node_modules/gsap/Observer.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports._getTarget = exports._horizontal = exports._vertical = exports._getVelocityProp = exports._proxies = exports._getProxyProp = exports._getScrollFunc = exports._scrollers = exports._isViewport = exports.default = exports.Observer = void 0;
...
},{"./Observer.js":"../node_modules/gsap/Observer.js"}],"views/pages/welcome.js":[function(require,module,exports) {
"use strict";
...
class welcomeView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), _Auth.default.currentUser.firstName, () => (0, _Router.gotoRoute)('/'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new welcomeView();
exports.default = _default;
},{"./../../App":"App.js","./../../Auth":"Auth.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Utils":"Utils.js","gsap":"../node_modules/gsap/index.js","gsap/ScrollTrigger":"../node_modules/gsap/ScrollTrigger.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _forums = _interopRequireDefault(require("./views/pages/forums"));
var _newPost = _interopRequireDefault(require("./views/pages/newPost"));
var _forumPost = _interopRequireDefault(require("./views/pages/forumPost"));
...
const routes = {
  ...
  '/forums': _forums.default,
  '/newPost': _newPost.default,
  '/forumPost': _forumPost.default,
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/forums":"views/pages/forums.js","./views/pages/newPost":"views/pages/newPost.js","./views/pages/forumPost":"views/pages/forumPost.js","./views/pages/welcome":"views/pages/welcome.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2(), this.title, this.subtitle) : "", _Router.anchorRoute, e => e.preventDefault(), this.user && this.user.firstName, this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : '', () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile'), () => _Auth.default.signOut(), this.menuClick, this.menuClick, this.menuClick, () => _Auth.default.signOut());
  }
});
