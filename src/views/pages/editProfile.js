          ...
          <div class="user-container">
            <div class="user-info">
              <sl-form class="page-form" @sl-submit=${this.updateProfileSubmitHandler.bind(this)}>
                ...
                <div class="input-bio">
                  <sl-textarea resize="auto" type="text" class="label-on-left" label="Bio" name="bio" value="${this.user.bio ? this.user.bio : ''}" placeholder="Tell us about yourself!"></sl-textarea>
                </div>                   
